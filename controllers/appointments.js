...
exports.getAppointment = (async (req, res, next) => {
    try {
        ...
        //     return res.send({
        //         success: false,
        //         message: `This user ID of ${req.user.id} is not authorized to access this appointment`
        //     })
        // }
...
// @route   POST /api/v1/:hospitalId/appointments/
// @access  Private
exports.addAppointment = (async (req, res, next) => {
    try {
        ...
        // validate existed appointment with condition
